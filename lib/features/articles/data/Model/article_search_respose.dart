...
class ArticleSearchResponse {
  ...
  factory ArticleSearchResponse.fromJson(String source) =>
      ArticleSearchResponse.fromMap(json.decode(source));
}
...
class Doc extends Article {
  ...
  factory Doc.fromMap(Map<String, dynamic> map) {
    return Doc(
      docAbstract:
          map['docAbstract'] != null ? map['docAbstract'] as String : "",
      webUrl: map['webUrl'] != null ? map['webUrl'] as String : "",
      snippet: map['snippet'] != null ? map['snippet'] as String : "",
      leadParagraph:
          map['leadParagraph'] != null ? map['leadParagraph'] as String : "",
      printSection:
          map['printSection'] != null ? map['printSection'] as String : "",
      printPage: map['printPage'] != null ? map['printPage'] as String : "",
      multimedia: List<Multimedia>.from(
          map['multimedia'].map((x) => Multimedia.fromMap(x))),
      headline: Headline.fromMap(map['headline']),
      keywords:
          List<Keyword>.from(map['keywords'].map((x) => Keyword.fromMap(x))),
      pubDate: map['pub_date'] != null ? map['pub_date'] as String : "",
      newsDesk: map['newsDesk'] != null ? map['newsDesk'] as String : "",
      sectionName:
          map['sectionName'] != null ? map['sectionName'] as String : "",
      subsectionName:
          map['subsectionName'] != null ? map['subsectionName'] as String : "",
...
class Person {
  ...
  factory Person.fromMap(Map<String, dynamic> map) {
    return Person(
      ...
      organization:
          map['organization'] != null ? map['organization'] as String : "",
...
class Headline {
  ...
  factory Headline.fromMap(Map<String, dynamic> map) {
    return Headline(
      ...
      contentKicker:
          map['contentKicker'] != null ? map['contentKicker'] as String : "",
      printHeadline:
          map['printHeadline'] != null ? map['printHeadline'] as String : "",
  ...
  factory Headline.fromJson(String source) =>
      Headline.fromMap(json.decode(source));
}
...
class Multimedia {
  ...
  factory Multimedia.fromJson(String source) =>
      Multimedia.fromMap(json.decode(source));
}
